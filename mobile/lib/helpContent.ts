...
export const MOBILE_HELP_ITEMS: MobileHelpItem[] = [
  ...
  { id: 'fss-purchase-order', role: 'FSS', topic: 'Purchase orders', question: 'What can I change on a purchase order?', answer: 'While open, FSS can confirm actual decimal quantity and unit price, upload receipt and proof, optionally save an OR number, and mark a vendor received. Before evidence or receiving, Change vendor for all changes the group and row-level Change vendor moves one item. Planned quantities, units, and calculated need stay locked.', popular: true, keywords: ['PO', 'OR number', 'receipt', 'proof', 'actual', 'change vendor'] },
  { id: 'fss-receipt-status', role: 'FSS', topic: 'Purchase orders', question: 'Why did uploading a receipt not change the vendor status?', answer: 'Upload both receipt and proof, review actual values, then use Mark vendor received. OR number is optional.', keywords: ['received', 'vendor group', 'upload'] },
