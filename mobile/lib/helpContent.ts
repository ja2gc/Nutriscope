...
export const mobileHelpItems: MobileHelpItem[] = [
  { id: 'shared-forgot-password', role: 'Shared', topic: 'Account', question: 'I forgot my password. What should I do?', answer: 'Tap Forgot password and enter your sign-in email. NutriScope sends the reset link to the verified recovery email saved for that account. Multiple accounts may share a recovery address, but each must verify it with its own code. Profile shows the current status and provides Add, Change, and Remove actions; removing the address disables password reset until a new one is verified. If you cannot access it, contact an administrator.', popular: true, keywords: ['reset', 'login'] },
  ...
  { id: 'fss-header-menu', role: 'FSS', topic: 'Navigation', question: 'Where are notifications, profile, Help, and Settings?', answer: 'The header bell opens notifications. Select a notification to open its announcement, purchase order, or report. The profile icon opens the side menu for Profile, Notifications, Help, Settings, update checking, and Sign out.', keywords: ['bell', 'profile', 'side menu'] },
  ...
  { id: 'fss-multiple-wards', role: 'FSS', topic: 'Accomplishments and reports', question: 'What do I enter in Daily Log?', answer: 'Enter the two numeric fields for diet lists collected and food apportioned and distributed. Other duties use checkboxes. The log starts on Today, and you can choose an earlier date. Re-saving the date updates its existing record.', keywords: ['daily log', 'number', 'today'] },
  { id: 'fss-off-duty', role: 'FSS', topic: 'Accomplishments and reports', question: 'How does Off duty work?', answer: 'Off duty records X for that date and keeps both numeric values at zero. You can correct the same daily log later.', keywords: ['absent', 'X'] },
  { id: 'fss-my-reports', role: 'FSS', topic: 'Accomplishments and reports', question: 'Where are my reports and PDF files?', answer: 'Open Accomplish → My Reports. Reports update progressively for each semi-monthly period. Choose View PDF or Download PDF. If a prepared file expired, NutriScope rebuilds it when you retry.', keywords: ['download', 'view', 'semi-monthly', 'PDF'] },
