...
export const mobileHelpItems: MobileHelpItem[] = [
  ...
  { id: 'fss-multiple-wards', role: 'FSS', topic: 'Accomplishments and reports', question: 'What do I enter in Daily Log?', answer: 'Enter the two numeric fields for diet lists collected and food apportioned and distributed. Other duties use checkboxes. The log starts on Today, and you can choose an earlier date.', keywords: ['daily log', 'number', 'today'] },
  { id: 'fss-off-duty', role: 'FSS', topic: 'Accomplishments and reports', question: 'How does Off duty work?', answer: 'Off duty records X for that date. You can correct the same daily log later.', keywords: ['absent', 'X'] },
  { id: 'fss-my-reports', role: 'FSS', topic: 'Accomplishments and reports', question: 'Where are my reports and PDF files?', answer: 'Open Accomplish → My Reports. Reports update progressively for each semi-monthly period. Choose View PDF or Download PDF.', keywords: ['download', 'view', 'semi-monthly'] },
