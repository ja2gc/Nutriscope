...
class AuditValuePresenter
{
    ...
    private const CHANGE_FIELDS = [
        ...
        AuditDomain::Procurement->value => [
            'name' => 'text', 'category' => 'text', 'contact' => 'text', 'address' => 'text',
            'payment_terms' => 'text', 'status' => 'enum', 'quantity' => 'number', 'unit_price' => 'currency',
            'total_amount' => 'currency', 'delivery_status' => 'enum',
            'estimated_population' => 'number', 'served_population' => 'number',
        ],
        AuditDomain::FoodService->value => [
            'name' => 'text', 'kind' => 'enum', 'category' => 'text', 'base_unit' => 'enum',
            'purchase_unit' => 'enum', 'units_per_purchase' => 'number', 'unit_cost' => 'currency',
            'vendor' => 'text', 'vendor_locked' => 'boolean',
            ...
            'service_date' => 'date', 'population' => 'number', 'estimated_population' => 'number',
            'served_population' => 'number', 'population_variance' => 'number',
            'total_value' => 'currency', 'has_shortfall' => 'boolean',
            'helped_food_prep' => 'boolean', 'stored_supplies' => 'boolean',
            'collected_diet_list' => 'boolean', 'apportioned_food' => 'boolean',
            'cleaned_utensils' => 'boolean', 'assistant_cook' => 'boolean',
            'maintained_cleanliness' => 'boolean', 'off_duty' => 'boolean',
