...
class AuditRouteCoverageTest extends TestCase
{
    ...
    public static function invalidPhasePolicies(): array
    {
        ...
        return [
            ...
            'future implemented early' => [[...$base, 'owner_task' => 6, 'implementation_state' => 'implemented']],
            'current still planned' => [[...$base, 'owner_task' => 5, 'implementation_state' => 'planned']],
        ];
    }
