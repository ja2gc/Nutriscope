...
class AccountOnboardingTest extends TestCase
{
    ...
    public function test_first_onboarding_submission_changes_only_the_temporary_password(): void
    {
        Notification::fake();
        ...
        $this->assertSame(0, Activity::where('event', 'recovery_email_changed')->where('causer_id', $user->id)->count());
