    ...
    */
    'taxonomy' => [
        ...
        'module_actions' => [
            ...
            AuditModule::Reports->value => [
                AuditAction::Created->value, AuditAction::Updated->value, AuditAction::Deleted->value,
                AuditAction::Viewed->value, AuditAction::Downloaded->value,
    ...
    'route_coverage' => [
        ...
        'POST api/admin/backups' => [
            'classification' => 'explicit_event',
            'source' => 'App\\Http\\Controllers\\Admin\\BackupController@store',
            'owner_task' => 8,
            'implementation_state' => 'implemented',
            'reason' => 'Manual backup requests record only the public backup reference and queued outcome.',
        ],
        'DELETE api/admin/backups/{backupRun}' => [
            'classification' => 'explicit_event',
            'source' => 'App\\Http\\Controllers\\Admin\\BackupController@destroy',
            'owner_task' => 8,
            'implementation_state' => 'implemented',
            'reason' => 'Recently Deleted transitions record only the public backup reference and outcome.',
        ],
        'POST api/admin/backups/{backupRun}/keep' => [
            'classification' => 'explicit_event',
            'source' => 'App\\Http\\Controllers\\Admin\\BackupController@keep',
            'owner_task' => 8,
            'implementation_state' => 'implemented',
            'reason' => 'Keep actions record only the public backup reference and outcome.',
        ],
        ...
        'POST api/fss/diet-list-counts' => [
            ...
            'owner_task' => 7,
            'implementation_state' => 'implemented',
            'reason' => 'Diet-list count persistence emits one explicit safe field-list event without ward or population values.',
        ],
        ...
        'POST api/rnd/ncp-records/{ncpRecord}/diagnoses/ai-suggest' => [
            ...
            'owner_task' => 6,
            'implementation_state' => 'implemented',
            'reason' => 'Successful AI suggestion access emits status only; prompts, outputs, and response values are never persisted.',
        ],
        ...
        'POST api/rnd/ncp-records/{ncpRecord}/meal-plans/generate' => [
            'classification' => 'explicit_event',
            'source' => 'App\\Http\\Controllers\\RND\\MealPlanController@generate',
            'owner_task' => 6,
            'implementation_state' => 'implemented',
        ...
        'POST api/rnd/ncp-records/{ncpRecord}/meal-plans/{mealPlan}/save-template' => [
            'classification' => 'explicit_event',
            'source' => 'App\\Http\\Controllers\\RND\\MealPlanController@saveTemplate',
            'owner_task' => 6,
            'implementation_state' => 'implemented',
