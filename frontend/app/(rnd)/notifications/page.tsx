  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex items-center gap-2 text-xs font-semibold text-zinc-400 select-none">
        ...
        <span className="text-zinc-650 font-bold">Notifications</span>
      </div>

      {/* Header */}
      <div className="border-b border-zinc-200 pb-5">
        <h2 className="text-xl font-extrabold text-zinc-950 tracking-tight flex items-center gap-2.5">
          <BellDot className="h-5 w-5 text-emerald-600 animate-pulse" />
          System Notifications & Alerts
        </h2>
        <p className="text-xs text-zinc-500 mt-1 select-none">
          Stay updated on urgent announcements, clinical rule alerts, and budget warnings.
        </p>
      </div>
      ...
      <div className="bg-white border border-zinc-200 rounded-2xl p-12 text-center max-w-2xl mx-auto shadow-sm">
        ...
        <h3 className="text-sm font-bold text-zinc-800 mt-4 uppercase tracking-wider">Notifications Scaffold</h3>
        <p className="text-xs text-zinc-500 mt-2 leading-relaxed">
          The upcoming live notification center will support database-backed messages, live webhooks, and visual alerts for clinical safety warnings.
        </p>
      </div>
    </div>
  );
