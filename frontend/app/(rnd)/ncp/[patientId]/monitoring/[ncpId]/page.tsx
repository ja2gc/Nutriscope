...
function Breadcrumb() {
  return (
    <div className="flex items-center gap-2 text-xs font-semibold text-warm-400 select-none flex-wrap">
    ...
    return (
      <div className="space-y-6 font-sans">
        ...
        <div className="bg-white border border-warm-200 rounded-2xl p-10 sm:p-12 text-center max-w-2xl mx-auto shadow-sm">
          ...
          <h3 className="text-sm font-bold text-warm-800 mt-4 uppercase tracking-wider">
            No Patient Selected
          </h3>
          ...
          <div className="mt-6">
            <Link
              href="/ncp/patients"
              className="inline-flex px-4 py-2.5 bg-forest-900 hover:bg-forest-900 active:bg-black text-white text-xs font-bold uppercase tracking-wider rounded-lg transition-colors select-none"
            >
    ...
    return (
      <div className="space-y-6 font-sans">
        ...
        <div className="bg-white border border-warm-200 rounded-2xl p-10 sm:p-12 text-center max-w-2xl mx-auto shadow-sm">
          ...
          <Link
            href={nextHref}
            className="inline-flex mt-6 px-4 py-2.5 bg-forest-900 hover:bg-forest-900 active:bg-black text-white text-xs font-bold uppercase tracking-wider rounded-lg transition-colors select-none"
          >
            Continue Care Plan
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white border border-warm-200 rounded-2xl p-5 shadow-sm">
              <h3 className="text-xs font-extrabold text-warm-700 uppercase tracking-wider mb-4">
                Encounter Details
              </h3>
            ...
            {latestNextDate && (
              <div className="bg-white border border-warm-200 rounded-2xl p-5 shadow-sm">
                <h3 className="text-xs font-extrabold text-warm-700 uppercase tracking-wider mb-3 flex items-center gap-2">
                  <Calendar className="h-3.5 w-3.5 text-emerald-600" />
                  Next Follow-up
                </h3>
                <p className="text-sm font-mono font-bold text-warm-900">
                ...
                <p className="text-[10px] text-warm-400 mt-1">Scheduled from last visit log.</p>
              </div>
            )}
