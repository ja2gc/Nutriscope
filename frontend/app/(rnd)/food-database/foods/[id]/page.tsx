...
import { fetchFoodItemById, updateFoodItem, FoodItem } from "@/services/foodDatabaseService";
    ...
    <div className="space-y-6 font-sans max-w-2xl mx-auto">
      ...
      <div className="border-b border-zinc-200 pb-5 flex items-center gap-4">
        ...
        <div>
          ...
          {food?.usda_fdc_id && (
            <p className="text-[10px] font-mono text-zinc-400 mt-0.5">USDA FDC ID: {food.usda_fdc_id}</p>
          )}
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-6 space-y-4 shadow-sm">
          <h3 className="text-xs font-extrabold text-zinc-700 uppercase tracking-wider">Pricing & Allergens</h3>
          <div>
