  ...
  return (
    <div className="space-y-6 font-sans max-w-3xl mx-auto">
      ...
      <div className="border-b border-zinc-200 pb-5 flex items-center gap-4">
        <Link href="/food-database" className="p-2 rounded-lg border border-zinc-200 hover:bg-zinc-50 text-zinc-500 transition-colors">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-1 select-none">Update ingredients and recalculate macro totals.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-6 space-y-4 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <button type="button" onClick={addRow} className="flex items-center gap-1.5 px-3 py-1.5 border border-zinc-300 rounded-lg text-zinc-600 hover:bg-zinc-50 cursor-pointer transition-colors text-[10px] font-bold uppercase tracking-wider">
                    ...
                    <div className="absolute top-full left-0 right-0 z-30 mt-1 bg-white border border-zinc-200 rounded-xl shadow-lg overflow-hidden">
                      {row.searchResults.map((food) => (
                        ...
                        >
                          ...
                          <div className="text-[10px] text-zinc-400">{food.calories} kcal · P {food.protein ?? 0}g · C {food.carbs ?? 0}g</div>
                        </button>
                      ))}
                    </div>
                  )}
