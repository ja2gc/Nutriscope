...
export default function AdminLayout({
  ...
  // Handle bfcache restore — redirect immediately if user is null or not Admin
  useEffect(() => {
  ...
  if (initializing) {
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-zinc-950 font-sans select-none">
