...
import { createBackup, listBackups, requestRecovery } from "./backupService";
...
describe("backup service", () => {
  ...
  test("uses protected endpoints for create and recovery", async () => {
    ...
    await requestRecovery("backup-1", { incident_type: "damaged_database", note: "Database records cannot be opened." });
