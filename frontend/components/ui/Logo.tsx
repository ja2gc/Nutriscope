    ...
    <div className="flex items-center gap-2.5 select-none shrink-0" data-variant={variant}>
      ...
      <div className="relative flex items-center justify-center h-8 w-8 shrink-0">
        ...
        >
          ...
          <line x1="16" y1="2" x2="16" y2="6" stroke={brand.orangeStroke} strokeWidth="1.5" />
          <line x1="16" y1="26" x2="16" y2="30" stroke={brand.orangeStroke} strokeWidth="1.5" />
          <line x1="2" y1="16" x2="6" y2="16" stroke={brand.orangeStroke} strokeWidth="1.5" />
          <line x1="26" y1="16" x2="30" y2="16" stroke={brand.orangeStroke} strokeWidth="1.5" />
          ...
          <path
            ...
            fill={brand.greenStroke}
            className="drop-shadow-sm"
          />
          <path
            d="M16 8C16 13 18.5 17 21 19.5"
            stroke={brand.greenSoftStroke}
            strokeWidth="1"
            strokeLinecap="round"
          ...
          <path
            d="M16 24V14"
            stroke={brand.greenAccentStroke}
            strokeWidth="1.2"
            strokeLinecap="round"
          />
        </svg>
      ...
      {!collapsed && (
        <div className="flex items-baseline">
          <span className={`text-base font-extrabold tracking-tight ${brand.nutriText}`}>
            Nutri
          </span>
          <span className={`text-base font-extrabold tracking-tight ${brand.scopeText}`}>
            Scope
          </span>
        </div>
      )}
