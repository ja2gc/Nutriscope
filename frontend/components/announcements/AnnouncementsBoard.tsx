            ...
            <form onSubmit={(e) => void saveAnnouncement(e)} className="flex min-h-0 flex-1 flex-col">
              ...
              {(isAdmin || user?.role === "RND") && (
                <div className="flex items-center gap-2.5">
                  ...
                  {draft.pinned && (
                    <span className="inline-flex px-2 py-0.5 rounded-full text-xs font-extrabold uppercase tracking-wider border bg-orange-50 text-[#EA580C] border-orange-200">
                      Pinned
                    </span>
                  )}
                </div>
              ...
              <div className="sticky bottom-0 flex items-center justify-between gap-3 border-t border-warm-100 bg-white px-5 py-4">
                <div className="flex flex-wrap gap-2">
                  {Object.entries(categoryStyles).map(([label, cls]) => (
                    <span
                      key={label}
                      className={`inline-flex px-2.5 py-1 rounded-full text-xs font-extrabold uppercase tracking-wider border ${cls}`}
                    >
                      {label}
                    </span>
                  ))}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="inline-flex px-2.5 py-1 rounded-full text-xs font-extrabold uppercase tracking-wider border bg-warm-50 text-warm-600 border-warm-200">
    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="border-b border-warm-200 pb-5 flex items-start justify-between gap-4">
        ...
        <Button
          variant="primary"
          onClick={openCreate}
          className="w-auto px-4 py-2 text-xs font-bold uppercase tracking-wider shrink-0"
        >
          Add Announcement
        </Button>
      </div>
      ...
      {error && (
        <div className="bg-red-50 border border-red-100 p-4 rounded-xl flex items-start gap-3">
          <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border border-red-200 text-xs font-black text-red-600 shrink-0 mt-0.5">!</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-3 space-y-2">
                      ...
                      <p className="text-sm text-warm-600 leading-relaxed whitespace-pre-wrap line-clamp-4">
                        {post.body}
                      </p>
                    </div>
